...
- [Blockbench](https://www.blockbench.net/) - a lighter 3D modeling software, more commonly used in the minecraft modding niche ([though some artists can make some really cool stuff with it outside of minecraft](https://x.com/violxiv/status/1942344562380292176))
